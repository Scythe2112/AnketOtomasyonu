...
<head>
    ...
    <title>En Çok Beğenilen Anketler</title>
                ...
                <div id="templatemo_main">
                    <div id="templatemo_sidebar">
                        ...
                        <ul>
                            ...
                            <li><a href="likes.jsp" class="current" >En Çok Beğenilen Anketler</a></li>
        ...
        <form action="" method="get">
            ...
            <ul class="lbe_list_w100">
                    ...
                    veritabani.baglanti database = new veritabani.baglanti();
                      String query3 = "SELECT anket_anahat.tarih,anket_anahat.anket_ad,uye_sonuc.anket_id ,sum(uye_sonuc.anket_begeni) as sayilar FROM anket_anahat inner join uye_sonuc on anket_anahat.anket_id = uye_sonuc.anket_id GROUP BY anket_ad  Order By sayilar DESC  LIMIT 15  ;";
