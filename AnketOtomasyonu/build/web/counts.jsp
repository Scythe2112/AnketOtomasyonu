...
<head>
    ...
    <title>En Çok Oylanan Anketler</title>
                ...
                <div id="templatemo_main">
                    <div id="templatemo_sidebar">
                        ...
                        <ul>
                            ...
                            <li><a href="counts.jsp" class="current">En Çok Oylanan Anketler</a></li>
    ...
    <div id="search">
        ...
        <div class="w_100" style="width: 560px;">
            ...
            <ul class="lbe_list_w100">
                    ...
                    String query2 = "SELECT anket_anahat.tarih,anket_anahat.anket_ad,uye_sonuc.anket_id ,count(uye_sonuc.anket_id) as sayilar FROM anket_anahat inner join uye_sonuc on anket_anahat.anket_id = uye_sonuc.anket_id GROUP BY anket_ad  Order By sayilar DESC  LIMIT 15  ;";
                    PreparedStatement pstmt2 = database.sorgu(query2);
                    ResultSet result2 = pstmt2.executeQuery();
                    int i=0;
                    while (result2.next()) {
                        dizi[i]=result2.getInt("anket_id");
                        i++;
                ...
                <div class="content_box">
                    ...
                    while (result4.next()) {
                        ...
                        pstmt3.setInt(1, result4.getInt("uye_id"));
                    ...
                    String query5 = "select COUNT(uye_sehir) AS toplam, uye_sehir from uye where  uye_id IN ('"+sql+"') GROUP BY uye_sehir  Order By toplam DESC LIMIT 1;";
                    PreparedStatement pstmt5 = database.sorgu(query5);
                    ResultSet result5=pstmt5.executeQuery();
                    
                    if(result5.next()){sehir=result5.getString("uye_sehir");}}
                %>    
